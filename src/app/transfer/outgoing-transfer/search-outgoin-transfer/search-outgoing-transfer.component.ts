...
export class SearchOutgoingTransferComponent
  ...
  implements OnInit, AfterViewInit
{
  ...
  outgoingTransferInput: SearchOutgoingTransferInput =
    new SearchOutgoingTransferInput();
  ...
  search(): void {
    ...
    if (this.outgoingTransferInput.number != undefined) {
      this.addToFilterParams(
        "number",
        "equal",
        this.outgoingTransferInput.number
      );
    }
    if (this.outgoingTransferInput.fromDate != undefined) {
      this.addToFilterParams(
        "fromDate",
        "equal",
        this.outgoingTransferInput.fromDate
      );
    }
    if (this.outgoingTransferInput.toDate != undefined) {
      this.addToFilterParams(
        "toDate",
        "equal",
        this.outgoingTransferInput.toDate
      );
    }
    if (this.outgoingTransferInput.paymentType != undefined) {
      this.addToFilterParams(
        "paymentType",
        "equal",
        this.outgoingTransferInput.paymentType
      );
    }
    if (
      this.outgoingTransferInput.clientId != undefined &&
      this.outgoingTransferInput.paymentType == 1
    ) {
      this.addToFilterParams(
        "clientId",
        "equal",
        this.outgoingTransferInput.clientId
      );
    }
    if (
      this.outgoingTransferInput.companyId != undefined &&
      this.outgoingTransferInput.paymentType == 2
    ) {
      this.addToFilterParams(
        "companyId",
        "equal",
        this.outgoingTransferInput.companyId
      );
    }
    if (this.outgoingTransferInput.countryId != undefined) {
      this.addToFilterParams(
        "countryId",
        "equal",
        this.outgoingTransferInput.countryId
      );
    }
    if (this.outgoingTransferInput.beneficiary != undefined) {
      this.addToFilterParams(
        "beneficiary",
        "equal",
        this.outgoingTransferInput.beneficiary
      );
    }
    if (this.outgoingTransferInput.beneficiaryAddress != undefined) {
      this.addToFilterParams(
        "beneficiaryAddress",
        "equal",
        this.outgoingTransferInput.beneficiaryAddress
      );
    }
    if (this.outgoingTransferInput.sender != undefined) {
      this.addToFilterParams(
        "sender",
        "equal",
        this.outgoingTransferInput.sender
      );
    }

    if (this.filtering) {
      this.gridInstance.query = new Query().where(this.filterParams);
      this.gridInstance.query.addParams(
        "tenantId",
        this.appSession.tenantId.toString()
      );
  ...
  openEditPage(id) {
    localStorage.setItem(
      "serach-outgoing-transfer-input",
      JSON.stringify(this.outgoingTransferInput)
    );
