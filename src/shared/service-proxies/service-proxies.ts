...
export class ExternalTransferServiceProxy {
     ...
     * @return Success
     */
    acceptExternalTransfer(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/ExternalTransfer/AcceptExternalTransfer?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAcceptExternalTransfer(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAcceptExternalTransfer(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processAcceptExternalTransfer(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
@Injectable()
export class PdfClientServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    /**
     * @param toDate (optional) 
     * @param totalClientBalancePdfs (optional) 
     * @return Success
     */
    getTotalClientBalance(toDate: string | undefined, totalClientBalancePdfs: TotalClientBalancePdf[] | undefined): Observable<PdfResultOutput> {
        let url_ = this.baseUrl + "/api/PdfClient/GetTotalClientBalance?";
        if (toDate === null)
            throw new Error("The parameter 'toDate' cannot be null.");
        else if (toDate !== undefined)
            url_ += "ToDate=" + encodeURIComponent("" + toDate) + "&";
        if (totalClientBalancePdfs === null)
            throw new Error("The parameter 'totalClientBalancePdfs' cannot be null.");
        else if (totalClientBalancePdfs !== undefined)
            totalClientBalancePdfs && totalClientBalancePdfs.forEach((item, index) => {
                for (let attr in item)
        			if (item.hasOwnProperty(attr)) {
        				url_ += "TotalClientBalancePdfs[" + index + "]." + attr + "=" + encodeURIComponent("" + (item as any)[attr]) + "&";
        			}
            });
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTotalClientBalance(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTotalClientBalance(response_ as any);
                } catch (e) {
    ...
    protected processGetTotalClientBalance(response: HttpResponseBase): Observable<PdfResultOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @param currentBalance (optional) 
     * @param fromDate (optional) 
     * @param toDate (optional) 
     * @return Success
     */
    getClientCashFlow(clientId: number | undefined, clientName: string | undefined, currencyId: number | undefined, currencyName: string | undefined, currentBalance: string | undefined, fromDate: string | undefined, toDate: string | undefined): Observable<PdfResultOutput> {
        let url_ = this.baseUrl + "/api/PdfClient/GetClientCashFlow?";
        if (clientId === null)
            throw new Error("The parameter 'clientId' cannot be null.");
        else if (clientId !== undefined)
            url_ += "ClientId=" + encodeURIComponent("" + clientId) + "&";
        ...
        if (currentBalance === null)
            throw new Error("The parameter 'currentBalance' cannot be null.");
        else if (currentBalance !== undefined)
            url_ += "CurrentBalance=" + encodeURIComponent("" + currentBalance) + "&";
        if (fromDate === null)
            throw new Error("The parameter 'fromDate' cannot be null.");
        else if (fromDate !== undefined)
            url_ += "FromDate=" + encodeURIComponent("" + fromDate) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetClientCashFlow(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetClientCashFlow(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PdfResultOutput>;
                }
            } else
    ...
    protected processGetClientCashFlow(response: HttpResponseBase): Observable<PdfResultOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
@Injectable()
export class PdfClientAndCompanyServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    /**
     * @param toDate (optional) 
     * @param totalBalancePdfs (optional) 
     * @return Success
     */
    getTotalBalance(toDate: string | undefined, totalBalancePdfs: TotalBalancePdf[] | undefined): Observable<PdfResultOutput> {
        let url_ = this.baseUrl + "/api/PdfClientAndCompany/GetTotalBalance?";
        if (toDate === null)
            throw new Error("The parameter 'toDate' cannot be null.");
        else if (toDate !== undefined)
            url_ += "ToDate=" + encodeURIComponent("" + toDate) + "&";
        if (totalBalancePdfs === null)
            throw new Error("The parameter 'totalBalancePdfs' cannot be null.");
        else if (totalBalancePdfs !== undefined)
            totalBalancePdfs && totalBalancePdfs.forEach((item, index) => {
                for (let attr in item)
        			if (item.hasOwnProperty(attr)) {
        				url_ += "TotalBalancePdfs[" + index + "]." + attr + "=" + encodeURIComponent("" + (item as any)[attr]) + "&";
        			}
            });
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTotalBalance(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTotalBalance(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PdfResultOutput>;
                }
            } else
    ...
    protected processGetTotalBalance(response: HttpResponseBase): Observable<PdfResultOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
@Injectable()
export class PdfCompanyServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    /**
     * @param toDate (optional) 
     * @param totalCompanyBalancePdfs (optional) 
     * @return Success
     */
    getTotalCompanyBalance(toDate: string | undefined, totalCompanyBalancePdfs: TotalCompanyBalancePdf[] | undefined): Observable<PdfResultOutput> {
        let url_ = this.baseUrl + "/api/PdfCompany/GetTotalCompanyBalance?";
        if (toDate === null)
            throw new Error("The parameter 'toDate' cannot be null.");
        else if (toDate !== undefined)
            url_ += "ToDate=" + encodeURIComponent("" + toDate) + "&";
        if (totalCompanyBalancePdfs === null)
            throw new Error("The parameter 'totalCompanyBalancePdfs' cannot be null.");
        else if (totalCompanyBalancePdfs !== undefined)
            totalCompanyBalancePdfs && totalCompanyBalancePdfs.forEach((item, index) => {
                for (let attr in item)
        			if (item.hasOwnProperty(attr)) {
        				url_ += "TotalCompanyBalancePdfs[" + index + "]." + attr + "=" + encodeURIComponent("" + (item as any)[attr]) + "&";
        			}
            });
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTotalCompanyBalance(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTotalCompanyBalance(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PdfResultOutput>;
                }
            } else
    ...
    protected processGetTotalCompanyBalance(response: HttpResponseBase): Observable<PdfResultOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return Success
     */
    getCompanyCashFlow(companyId: number | undefined, companyName: string | undefined, currencyId: number | undefined, currencyName: string | undefined, currentBalance: string | undefined, fromDate: string | undefined, toDate: string | undefined): Observable<PdfResultOutput> {
        let url_ = this.baseUrl + "/api/PdfCompany/GetCompanyCashFlow?";
        if (companyId === null)
            throw new Error("The parameter 'companyId' cannot be null.");
        else if (companyId !== undefined)
            url_ += "CompanyId=" + encodeURIComponent("" + companyId) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetCompanyCashFlow(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetCompanyCashFlow(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PdfResultOutput>;
                }
            } else
    ...
    protected processGetCompanyCashFlow(response: HttpResponseBase): Observable<PdfResultOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class PdfTreasuryBalanceServiceProxy {
     ...
     * @return Success
     */
    getTreasuryCashFlow(currencyId: number | undefined, fromDate: string | undefined, toDate: string | undefined): Observable<PdfResultOutput> {
        let url_ = this.baseUrl + "/api/PdfTreasuryBalance/GetTreasuryCashFlow?";
        if (currencyId === null)
            throw new Error("The parameter 'currencyId' cannot be null.");
        else if (currencyId !== undefined)
            url_ += "CurrencyId=" + encodeURIComponent("" + currencyId) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetTreasuryCashFlow(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetTreasuryCashFlow(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<PdfResultOutput>;
                }
            } else
    ...
    protected processGetTreasuryCashFlow(response: HttpResponseBase): Observable<PdfResultOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class PdfResultOutput implements IPdfResultOutput {
    path: string | undefined;

    constructor(data?: IPdfResultOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): PdfResultOutput {
        data = typeof data === 'object' ? data : {};
        let result = new PdfResultOutput();
        result.init(data);
        return result;
    }
...
export interface IPdfResultOutput {
    path: string | undefined;
}
...
export class TotalBalancePdf implements ITotalBalancePdf {
    id: number;
    name: string | undefined;
    ...
    balance2: number;
    currency3: string | undefined;
    balance3: number;
    currency4: string | undefined;
    balance4: number;
    readonly forHim: number;
    readonly onHim: number;
    readonly total: string | undefined;

    constructor(data?: ITotalBalancePdf) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.name = _data["name"];
            this.currency0 = _data["currency0"];
            this.balance0 = _data["balance0"];
            this.currency1 = _data["currency1"];
            this.balance1 = _data["balance1"];
            this.currency2 = _data["currency2"];
            this.balance2 = _data["balance2"];
            this.currency3 = _data["currency3"];
            this.balance3 = _data["balance3"];
            this.currency4 = _data["currency4"];
            this.balance4 = _data["balance4"];
            (<any>this).forHim = _data["forHim"];
            (<any>this).onHim = _data["onHim"];
            (<any>this).total = _data["total"];
        }
    }

    static fromJS(data: any): TotalBalancePdf {
        data = typeof data === 'object' ? data : {};
        let result = new TotalBalancePdf();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["id"] = this.id;
        data["name"] = this.name;
        data["currency0"] = this.currency0;
        data["balance0"] = this.balance0;
        data["currency1"] = this.currency1;
        data["balance1"] = this.balance1;
        data["currency2"] = this.currency2;
        data["balance2"] = this.balance2;
        data["currency3"] = this.currency3;
        data["balance3"] = this.balance3;
        data["currency4"] = this.currency4;
        data["balance4"] = this.balance4;
        data["forHim"] = this.forHim;
        data["onHim"] = this.onHim;
        data["total"] = this.total;
        return data;
    }

    clone(): TotalBalancePdf {
        const json = this.toJSON();
        let result = new TotalBalancePdf();
        result.init(json);
        return result;
...
export interface ITotalBalancePdf {
    id: number;
    name: string | undefined;
    currency0: string | undefined;
    balance0: number;
...
export class TotalClientBalancePdf implements ITotalClientBalancePdf {
    clientId: number;
    clientName: string | undefined;
    currency0: string | undefined;
    balance0: number;
    ...
    constructor(data?: ITotalClientBalancePdf) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TotalClientBalancePdf {
        data = typeof data === 'object' ? data : {};
        let result = new TotalClientBalancePdf();
        result.init(data);
        return result;
    }
...
export interface ITotalClientBalancePdf {
    clientId: number;
    clientName: string | undefined;
    currency0: string | undefined;
    balance0: number;
...
export class TotalCompanyBalancePdf implements ITotalCompanyBalancePdf {
    companyId: number;
    companyName: string | undefined;
    currency0: string | undefined;
    balance0: number;
    ...
    constructor(data?: ITotalCompanyBalancePdf) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): TotalCompanyBalancePdf {
        data = typeof data === 'object' ? data : {};
        let result = new TotalCompanyBalancePdf();
        result.init(data);
        return result;
    }
...
export interface ITotalCompanyBalancePdf {
    companyId: number;
    companyName: string | undefined;
    currency0: string | undefined;
    balance0: number;
